...
while True:
    ...
    if player_number == -1:
        ...
        print("The Computers number was greater than your number",
              str(computer_higher) + "%","of the time")
        print("Your number was higher than the computer's number",
              str(player_higher) + "%","of the time")
